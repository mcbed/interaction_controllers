...
#include "model_predictive_impedance_controller/model_predictive_impedance_controller.hpp"
...
namespace model_predictive_impedance_controller
{
using hardware_interface::LoanedCommandInterface;

ModelPredictiveImpedanceController::ModelPredictiveImpedanceController()
...
CallbackReturn ModelPredictiveImpedanceController::on_init()
{
  try
  {
...
CallbackReturn ModelPredictiveImpedanceController::on_configure(
...
ModelPredictiveImpedanceController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
ModelPredictiveImpedanceController::state_interface_configuration() const
{
  controller_interface::InterfaceConfiguration conf;
  conf.type = controller_interface::interface_configuration_type::INDIVIDUAL;
...
CallbackReturn ModelPredictiveImpedanceController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn ModelPredictiveImpedanceController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::return_type ModelPredictiveImpedanceController::update(const rclcpp::Time & time, const rclcpp::Duration & period)
{
...
PLUGINLIB_EXPORT_CLASS(
  model_predictive_impedance_controller::ModelPredictiveImpedanceController, controller_interface::ControllerInterface)
