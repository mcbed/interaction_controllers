...
#include "variable_impedance_controller/variable_impedance_controller.hpp"
...
namespace variable_impedance_controller
{
using hardware_interface::LoanedCommandInterface;

VariableImpedanceController::VariableImpedanceController()
...
CallbackReturn VariableImpedanceController::on_init()
{
  try
  {
...
CallbackReturn VariableImpedanceController::on_configure(
...
VariableImpedanceController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration
VariableImpedanceController::state_interface_configuration() const
{
  controller_interface::InterfaceConfiguration conf;
  conf.type = controller_interface::interface_configuration_type::INDIVIDUAL;
...
CallbackReturn VariableImpedanceController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn VariableImpedanceController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::return_type VariableImpedanceController::update(const rclcpp::Time & time, const rclcpp::Duration & period)
{
...
PLUGINLIB_EXPORT_CLASS(
  variable_impedance_controller::VariableImpedanceController, controller_interface::ControllerInterface)
